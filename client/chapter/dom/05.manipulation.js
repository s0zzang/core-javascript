...
h1.insertAdjacentHTML(
  'beforebegin',
  /*html*/ `
  <li class="list">beforebegin</li>
`
);
h1.insertAdjacentHTML(
  'beforeend',
  /*html*/ `
  <li class="list">beforeend</li>
`
);
h1.insertAdjacentHTML(
  'afterbegin',
  /*html*/ `
  <li class="list">afterbegin</li>
`
);
h1.insertAdjacentHTML(
  'afterend',
  /*html*/ `
  <li class="list">afterend</li>
`
);

insertLast('.second', '<div class="tiger">부대찌개</div>');
